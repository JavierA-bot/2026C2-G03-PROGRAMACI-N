...
ARCHIVO_DATOS = r"Semana 8\datos_clinica.json"
...
if len(pacientes) == 0:
    ...
    print("Llaves:", primer_paciente.keys())
    ...
    conteo_hombres = 0
    adultos_mayores = []
    total_diagnosticos = 0   # Reto opcional
    conteo_enfermedades = {}  #profe
    ...
    for paciente in pacientes:
        ...
        enfermedades = paciente['enfermedades'] #profe
    ...
    print("Diagnosticos:", total_diagnosticos)
    
    for enfermedad, cantidad in conteo_enfermedades.items():
        print(f"Diagnósticos {enfermedad} : {cantidad}")

    # REQUERIMIENTO 5:
    # Escriba dos conclusiones basadas en los resultados.
    print("\nCONCLUSIONES")
    print("Conclusion 1: La edad promedio de los pacientes es de 45.2 años.")
    print("Conclusion 2: Hay más mujeres que hombres y se registraron 3 adultos mayores.")
